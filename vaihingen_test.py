...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, help="Path to  config", default="config/uavid/unetformer_lsk_t_gai.py")
    arg("-o", "--output_path", type=Path, help="Path where to save resulting masks.", default="output")
