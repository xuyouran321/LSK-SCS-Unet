...
from geoseg.models.ablation_network.lsk_convssm_nose import lsk_convssm_noSE
...
weights_name = "lsk_convssm_noSE"
weights_path = "model_weights/uavid/{}".format(weights_name)
test_weights_name = "lsk_convssm_test_noSE"#拼接路径
...
#  define the network
net = lsk_convssm_noSE(num_classes=num_classes)
# define the loss
