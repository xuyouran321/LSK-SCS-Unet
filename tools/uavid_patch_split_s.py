...
def parse_args():
    ...
    parser.add_argument("--input-dir", default="../data/uavid/test")
    parser.add_argument("--output-img-dir", default="../data/uavid/test_val/images")
    parser.add_argument("--output-mask-dir", default="../data/uavid/test_val/masks")
