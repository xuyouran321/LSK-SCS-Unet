...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, help="Path to  config", default="config/uavid/A2FPN_test.py")###############################
    arg("-o", "--output_path", type=Path, help="Path to save resulting masks.", default="output_img/new_test/a2fpn/patch")#########################
...
def main():
    ...
    model = Supervision_Train.load_from_checkpoint('model_weights/uavid/A2FPN-1024-1024crop_xu/last.ckpt',config=config)##################################
