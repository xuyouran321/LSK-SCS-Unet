...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, help="Path to  config", default="config/uavid/banet_test.py")###############################
    arg("-o", "--output_path", type=Path, help="Path to save resulting masks.", default="output_img/new_test/banet/patch")#########################
...
def main():
    ...
    model = Supervision_Train.load_from_checkpoint('model_weights/uavid/BANet-1024-1024crop/last.ckpt',config=config)##################################
